    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            ...
            <h4> <b>Welcome to Mandera County Wards & NG-CDF Bursary Management System</b></h4>
              ...
              2. You can only have one user account per applicant. Trying to have fake accounts will lead to automatic disqualifications.<br />
              ...
              5. Once you submit your application, you can't reapply. Take your time during the application process.<br />
              6. Make sure the provided information is correct and accurate.
