...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#sub_county_wards" role="tab" data-toggle="tab">
                {{ trans('cruds.ward.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="sub_county_wards">
            @includeIf('admin.subCounties.relationships.subCountyWards', ['wards' => $subCounty->subCountyWards])
        </div>
    </div>
</div>
